...
public:
    ...
    void setupUi(QWidget *ImageViewerWidget)
    {
        ...
        labelFilePath = new QLabel(ImageViewerWidget);
        labelFilePath->setObjectName(QStringLiteral("labelFilePath"));
        labelFilePath->setGeometry(QRect(9, 42, 1181, 16));
        ...
        labelScans = new QLabel(ImageViewerWidget);
        labelScans->setObjectName(QStringLiteral("labelScans"));
        labelScans->setGeometry(QRect(9, 61, 1181, 16));
        layoutWidget1 = new QWidget(ImageViewerWidget);
        layoutWidget1->setObjectName(QStringLiteral("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(26, 81, 1166, 776));
        ...
        sizePolicy2.setHeightForWidth(labelImage5->sizePolicy().hasHeightForWidth());
        labelImage5->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(labelImage6->sizePolicy().hasHeightForWidth());
        labelImage6->setSizePolicy(sizePolicy2);
